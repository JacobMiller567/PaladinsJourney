...
public class Boomerang : MonoBehaviour  // On WeaponHolder
{
  ...
  private void Start()
    {
      ...
      inFrontOfPlayer = new Vector3(player.transform.position.x, player.transform.position.y + 1, player.transform.position.z) + player.transform.forward * 10f;
...
/*
    void OnCollisionEnter(Collision collision)
    {
      ...
      {
        Damageable damagable = collision.transform.GetComponent<Damageable>();
        damagable?.Damage(damage); // damage enemy
